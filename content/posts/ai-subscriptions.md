...
vamos comparar las diferentes subscripciones de IA que disponibles, tambien consejos
...
Mirando un ranking de modelos <https://www.vals.ai/benchmarks/swebench> podemos ver que los modelos TOP, y mas caros, son los de Claude de Anthropic, GPT de OpenAI y Gemini de Google.
...
* **Cursor** → Fork de VSC con IA nativa. Modo agente, cloud agents, Bugbot para revision de codigo
* **Codex** → De OpenAI. IDE en la web para que el agente trabaje de forma autonoma en tareas de programación
